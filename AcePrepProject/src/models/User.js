...
//  {collection:"user"}                    // when particular collection name is required
...
//the pre post middleware must be added between the schema declaration and the model declaration

// to send the email , go to your google account , manage account , turn on 2 step verification , then go in app passwords , then type name of the app you want your app password for , then create it , copy it and paste it in MAIL_PASS of .env .
